...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
     ...
     <p>
           Cantidad: <asp:TextBox ID ="boxcantidad" TextMode ="SingleLine" Columns ="5" runat="server"></asp:TextBox>
     </p>
    </asp:Panel>
     <p>
         Precio total:
     </p>
     <asp:Button ID ="botoncompra" Text ="Comprar" runat ="server" />
     <p>
     <asp:Button ID ="botoneliminar" Text ="Eliminar del carrito" runat ="server" style="margin-bottom: 0px" /></p>
</asp:Content>
